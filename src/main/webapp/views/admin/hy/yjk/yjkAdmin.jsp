...
<head>
	...
	<link href="${pageContext.request.contextPath}/css/admin/hy/yjk/yjkAdmin.css" rel="stylesheet" type="text/css"/>
	<title>亚健康化验</title>
</head>
<body>
