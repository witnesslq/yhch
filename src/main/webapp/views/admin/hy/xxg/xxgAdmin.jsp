...
<head>
	...
	<link href="${pageContext.request.contextPath}/css/admin/hy/xxg/xxgAdmin.css" rel="stylesheet" type="text/css"/>
	<title>心血管化验</title>
</head>
<body>
