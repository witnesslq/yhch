...
<head>
	...
	<link href="${pageContext.request.contextPath}/css/admin/hy/shenzang/shenzang.css" rel="stylesheet" type="text/css"/>
	<title>肾脏泌尿化验</title>
</head>
<body>
