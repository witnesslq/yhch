...
<head>
	...
	<link href="${pageContext.request.contextPath}/css/admin/hy/xueye/xueyeAdmin.css" rel="stylesheet" type="text/css"/>
	<title>血液系统化验</title>
</head>
<body>
