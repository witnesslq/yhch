...
<head>
	...
	<link href="${pageContext.request.contextPath}/css/admin/hy/nanfu/nanfuAdmin.css" rel="stylesheet" type="text/css"/>
	<title>男妇化验</title>
</head>
<body>
