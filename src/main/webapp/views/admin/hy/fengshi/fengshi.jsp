...
<head>
	...
	<link href="${pageContext.request.contextPath}/css/admin/hy/fengshi/fengshi.css" rel="stylesheet" type="text/css"/>
	<title>风湿免疫化验</title>
</head>
<body>
